...
export class ApiAjaxController extends AbstractApiAjaxController
{
	...
	/**
	 * Reads the settings of the application.
	 * @returns {Object} The read settings of the application.
	 */
	async readSettings()
	{
	...
	/**
	 * Write the settings of the application.
	 * @param {Settings} settings The settings of the application to write.
	 */
