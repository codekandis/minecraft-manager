...
export class StationPositionsOffsetPresets extends Abstract
{
	 ...
	 * @type {PositionOffset}
	 */
	#_concourseMining1 = new PositionOffset( -16, 15, -15 );

	/**
	 * Stores the position offset concourse mining 2.
	 * @type {PositionOffset}
	 */
	#_concourseMining2 = new PositionOffset( 3, 0, -70 );

	/**
	 * Stores the position offset concourse mining R 1.
	 * @type {PositionOffset}
	 */
	#_concourseMiningR1 = new PositionOffset( -14, 15, -15 );

	/**
	 * Stores the position offset concourse mining R 2.
	 * @type {PositionOffset}
	 */
	#_concourseMiningR2 = new PositionOffset( 3, 0, -70 );

	/**
	 * Stores the position offset concourse mining L 1.
	 * @type {PositionOffset}
	 */
	#_concourseMiningL1 = new PositionOffset( -16, 15, -15 );

	/**
	 * Stores the position offset concourse mining L 2.
	 * @type {PositionOffset}
	 */
	#_concourseMiningL2 = new PositionOffset( 5, 0, -70 );

	/**
	 * Stores the position offset concourse mining RL 1.
	 * @type {PositionOffset}
	 */
	#_concourseMiningRL1 = new PositionOffset( -14, 15, -15 );

	/**
	 * Stores the position offset concourse mining RL 2.
	 * @type {PositionOffset}
	 */
	#_concourseMiningRL2 = new PositionOffset( 5, 0, -70 );
	 ...
	 * @returns {PositionOffset} The position offset concourse mining RL 1.
	 */
